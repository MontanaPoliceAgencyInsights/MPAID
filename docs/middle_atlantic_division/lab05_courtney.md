...
in Middle Atlantic Division</caption>
<colgroup>
<col style="width: 8%" />
<col style="width: 5%" />
<col style="width: 5%" />
...
Differences-in-Differences Linear Regression Analysis of NMTC in Middle
Atlantic Division

Across the SVI flag models for the Middle Atlantic Division, the
...
vulnerability appears to be working in the Middle Atlantic Division.
...
![](lab05_courtney_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->

The slopegraph for SES SVI flags for the NMTC program indicates that in
the Middle Atlantic Division our NMTC Participant Tracts had a notable
...
![](lab05_courtney_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
that in the Middle Atlantic Division our NMTC Participant Tracts had a
