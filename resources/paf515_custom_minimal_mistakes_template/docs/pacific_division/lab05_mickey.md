...
neighborhoods across the Pacific Division, we will employ a
...
Across the SVI flag models for the Pacific Division, the
...
vulnerability appears to be working in the Pacific Division.
...
![](lab05_mickey_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->

The slopegraph for SES SVI flags for the NMTC program indicates that in
the Pacific Division our NMTC Participant Tracts had a notable
...
![](lab05_mickey_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
that in the Pacific Division our NMTC Participant Tracts had a
