...
Across the SVI flag models for the Mountain Division, the
...
vulnerability appears to be working in the Mountain Division.
...
![](lab05_sparky_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->

The slopegraph for SES SVI flags for the NMTC program indicates that in
the Mountain Division our NMTC Participant Tracts had a notable
...
![](lab05_sparky_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
that in the Mountain Division our NMTC Participant Tracts had a
